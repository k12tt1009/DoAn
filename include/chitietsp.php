			...
			<div class="row">
					...
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								...
								<li data-thumb="images/<?php echo $row_chitiet['sanpham_images'] ?>">
									<div class="thumb-image">
										<img src="images/<?php echo $row_chitiet['sanpham_images'] ?>" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<div class="product-single-w3l">
						<p> <?php echo $row_chitiet['sanpham_chitiet'] ?> </p><br><br><br>
