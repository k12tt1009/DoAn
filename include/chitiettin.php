		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-12 welcome-left">
					<h5 class="my-sm-3 my-2"><?php echo $row_baiviet['tomtat'] ?></h5>
					<img src="images/<?php echo $row_baiviet['baiviet_image'] ?>" class="img-fluid" alt=" "><br>
					<h4 class="my-sm-3 my-2"><?php echo $row_baiviet['noidung'] ?></h4>
				</div>
			</div><br>
		</div>
	</div>
