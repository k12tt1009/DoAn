...
<?php
	if(isset($_POST['themsanpham'])){
		...
		$hinhanhchitiet = $_FILES['hinhanh']['name'];
		...
		$hinhanhchitiet_tmp = $_FILES['hinhanh']['tmp_name'];
		$sql_insert_product = mysqli_query($con,"INSERT INTO tbl_sanpham(sanpham_name,sanpham_chitiet,sanpham_mota,sanpham_gia,sanpham_giakhuyenmai,sanpham_soluong,sanpham_image,sanpham_images,category_id) values ('$tensanpham','$chitiet','$mota','$gia','$giakhuyenmai','$soluong','$hinhanh','$hinhanhchitiet','$danhmuc')");
		...
		<?php
			...
			<?php
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="file" class="form-control" name="hinhanhchitiet"><br>
					<label>Giá</label>
