			...
			<form action="" method="POST">
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><?php echo number_format($row_donhang['sanpham_giakhuyenmai']); ?></td>
				...
				<select class="form-control" name="xuly">
					...
					<option value="1">Đã xử lý | Giao hàng thành công</option>
				</select><br>
			...
			<div class="col-md-7">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a href="?xoadonhang=<?php echo $row_donhang['mahang'] ?>">Xóa đơn hàng</a> || <a href="?quanly=xemdonhang&mahang=<?php echo $row_donhang['mahang'] ?>">Xem chi tiết </a></td>
					</tr>
					 <?php
					} 
					?> 
